			...
			case 1:
				...
				case 5:
				{
					...
					for(int i = 0; i < empArray.size(); i++) {
								...
								if(empArray.get(i) instanceof HR)
								{
									HR h = (HR) empArray.get(i);
									System.out.println(h.toString());
								}
								if(empArray.get(i) instanceof Admin)
								{
									Admin ad = (Admin) empArray.get(i);
									System.out.println(ad.toString());
								}
								if(empArray.get(i) instanceof SalesMAnager)
								{
									SalesMAnager sm = (SalesMAnager) empArray.get(i);
